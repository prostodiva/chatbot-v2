...
/**
 * Async thunk for creating new chat conversations
 *
 * Creates a new conversation and adds it to the user's chat list
 *
...
>("chat/add", async (initialMessage, { rejectWithValue }) => {
  try {
